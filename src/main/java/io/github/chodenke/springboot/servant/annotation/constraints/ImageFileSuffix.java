...
@Retention(RUNTIME)
@Pattern(regexp = RegexPool.IMAGE_FILE_SUFFIX)
public @interface ImageFileSuffix {
     ...
     * @return 字符串类型的提示信息
     */
    String message() default "must be a common image file suffix";
