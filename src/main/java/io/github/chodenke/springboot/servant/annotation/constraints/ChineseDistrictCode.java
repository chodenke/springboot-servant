...
@Retention(RUNTIME)
@Pattern(regexp = RegexPool.CHINESE_DISTRICT_CODE)
public @interface ChineseDistrictCode {
     ...
     * @return 字符串类型的提示信息
     */
    String message() default "must be a chinese district code";
