...
@Retention(RUNTIME)
@Pattern(regexp = RegexPool.CHINESE_BANK_ACCOUNT)
public @interface ChineseBankAccount {
     ...
     * @return 字符串类型的提示信息
     */
    String message() default "must be a chinese bank account";
