...
@Retention(RUNTIME)
@Pattern(regexp = RegexPool.CHINESE_PLATE_NUMBER)
public @interface ChinesePlateNumber {
     ...
     * @return 字符串类型的提示信息
     */
    String message() default "must be a chinese plate number";
