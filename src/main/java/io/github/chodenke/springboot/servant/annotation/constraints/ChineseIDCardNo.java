...
@Retention(RUNTIME)
@Pattern(regexp = RegexPool.CHINESE_IDCARD_NO)
public @interface ChineseIDCardNo {
     ...
     * @return 字符串类型的提示信息
     */
    String message() default "must be a chinese ID card number";
